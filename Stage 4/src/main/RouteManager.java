...
public class RouteManager {
    ...
    private static final String ROUTES_CSV_FILE_PATH = "Stage 4/data/routes.csv";
    private static final String BUS_STOPS_CSV_FILE_PATH = "Stage 4/data/bus_stops.csv";
